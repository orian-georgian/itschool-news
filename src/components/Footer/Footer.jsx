    ...
    <footer className="footer">
      <Container>
        <div className="content ">
          <div className="links">
            <div className="links-column logo-and-stuff">
              <img
                src="https://www.itschool.ro/images/logo-itschool-light.svg"
                alt="logo"
              />
              <p>
                Din 2014, peste 10000 de începători ne-au ales să le fim
                partener în procesul lor de transformare digitală.
              </p>
            ...
            <div className="links-column it-school">
              <h4 className="heading4">IT School</h4>
            ...
            <div className="links-column more">
              <h4 className="heading4">Mai mult</h4>
            ...
            <div className="links-column utils">
              <h4 className="heading4">Utile</h4>
